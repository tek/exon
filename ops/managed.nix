{
  ...
  overrides = {
    latest = {
      ...
      unordered-containers = {
        version = "0.2.20.1";
        hash = "10yqrpb3bi0642mzh220dz4gkwbamdpqr0fmc83k635rp98pnnmz";
        repo = "hackage.haskell.org";
      };
      uuid-types = {
        version = "1.0.6";
  ...
  solver = {
    latest = {
      ansi-wl-pprint = {
        version = "1.0.2";
        hash = "0a0r6zkliryvcwr87divilq9zkfzz775s5ybmmfayd9dsx8ixn64";
        repo = "hackage.haskell.org";
      };
      boring = {
        jailbreak = true;
      ...
      hspec-discover = {
        version = "2.11.12";
        hash = "07p4gvlkdbimrzhsw1ahyz9fsa7p039dp9hq90yd188bxbls01f4";
        repo = "hackage.haskell.org";
      };
      incipit-base = {
        jailbreak = true;
      ...
      regex-posix = {
        version = "0.96.0.2";
        hash = "15441iqn81vc1sia1hdpfivsxaibs31zkpv9sy10n6kliiarljgz";
        repo = "hackage.haskell.org";
      };
      th-abstraction = {
        version = "0.7.1.0";
